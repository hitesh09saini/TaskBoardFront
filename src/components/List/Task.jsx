                ...
                <div className="flex gap-2 items-start flex-1">
                    <i
                        ...
                        className={`${!status
                            ...
                            } p-1 rounded cursor-pointer text-lg fa-solid ${!status ? 'fa-square-check' : 'fa-ban'}`}
                    ></i>
                    ...
                    {isEdit ? (
                        ...
                        <div>
                            <h4 className={`font-medium break-words ${status ? 'line-through text-gray-400' : ''}`}>
                                {linkifyText(item.taskName, false)}
                            </h4>
                            <p className="text-sm text-gray-500 break-words max-w-[300px]">
